      ...
      <Row className="h-100">
        ...
        <Col md={6} className={styles.rightContainer}>
          <Col className={styles.rightInnerContainer}>
            ...
            <form>
              <label className="sr-only" htmlFor="signupEmail">Sign up email</label>
              <input
                id="signupEmail"
              ...
              <div className="mb-3 position-relative">
                <label className="sr-only" htmlFor="signupPassword">Sign up password</label>
                <input
                  id="signupPassword"
              ...
              <div className="mb-3 position-relative">
                <label className="sr-only" htmlFor="confirmSignupPassword">Confirm sign up password</label>
                <input
            ...
            <button
              className={`${styles.loginBtn} 
                ${isLoading ? styles.disabledLoginBtn : ""} w-100`}
